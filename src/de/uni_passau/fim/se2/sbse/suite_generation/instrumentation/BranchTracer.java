...
public final class BranchTracer implements IBranchTracer {
    ...
    public void passedBranch(final int i, final int opcode, final int trueBranch, final int falseBranch) {
        ...
        switch (opcode) {
            case IFEQ: // i == 0
                ...
                distanceFalse = (i == 0) ? 1.0 : 0.0;
                break;
            case IFNE: // i != 0
                distanceTrue = (i != 0) ? 0.0 : 1.0;
                distanceFalse = (i != 0) ? Math.abs(i) : 0.0;
                break;
            case IFLT: // i < 0
                distanceTrue = (i < 0) ? 0.0 : (i + 1);
                distanceFalse = (i < 0) ? -i : 0.0;
                break;
            case IFLE: // i <= 0
                distanceTrue = (i <= 0) ? 0.0 : i;
                distanceFalse = (i <= 0) ? -(i - 1) : 0.0;
                break;
            case IFGT: // i > 0
                distanceTrue = (i > 0) ? 0.0 : -(i - 1);
                distanceFalse = (i > 0) ? i : 0.0;
    ...
    public void passedBranch(final int i, final int j, final int opcode, final int trueBranch,
        ...
        switch (opcode) {
            case IF_ICMPEQ: // i == j
                distanceTrue = (i == j) ? 0.0 : Math.abs(i - j);
                distanceFalse = (i == j) ? 1.0 : 0.0;
                break;
            case IF_ICMPNE: // i != j
                distanceTrue = (i != j) ? 0.0 : 1.0;
                distanceFalse = (i != j) ? Math.abs(i - j) : 0.0 ;
                break;
            case IF_ICMPLT: // i < j
                distanceTrue = (i < j) ? 0.0 : (i - j + 1);
                distanceFalse = (i < j) ? (j - i) : 0.0 ;
                break;
            case IF_ICMPLE: // i <= j
                distanceTrue = (i <= j) ? 0.0 : (i - j);
                distanceFalse = (i <= j) ? (j - i + 1) : 0.0 ;
                break;
            case IF_ICMPGT: // i > j
                distanceTrue = (i > j) ? 0.0 : (j - i + 1);
                distanceFalse = (i > j) ? (i - j) : 0.0;
                break;
            case IF_ICMPGE: // i >= j
                distanceTrue = (i >= j) ? 0.0 : (j - i);
                distanceFalse = (i >= j) ?  (i - j + 1) : 0.0;
                break;
            default:
                distanceTrue = i;
                distanceFalse = j;
    ...
    public void passedBranch(final Object o, final int opcode, final int trueBranch,
        ...
        switch (opcode) {
            case IFNULL: // o == null
                ...
                distanceFalse = (o == null) ? 1.0 : 0.0;
                break;
            case IFNONNULL: // o != null
                distanceTrue = (o != null) ? 0.0 : 1.0;
                distanceFalse = (o != null) ? 1.0 : 0.0;
                break;
            default:
    ...
    private void traceBranchDistance(final int trueBranch, final double distanceTrue, final int falseBranch, final double distanceFalse) {
        distances.compute(trueBranch, (_, oldDistance) ->
                (oldDistance == null || distanceTrue < oldDistance) ? distanceTrue : oldDistance
        );

        distances.compute(falseBranch, (_, oldDistance) ->
                (oldDistance == null || distanceFalse < oldDistance) ? distanceFalse : oldDistance
        );
    }
